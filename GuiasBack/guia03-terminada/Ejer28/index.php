...
y que sólo si se lee el archivo desde la página se podrá acceder a su texto claro, es decir se desencriptará.
...
Enigma::Encriptar("Hoy es lunes", "./misArchivos/enigma.txt");

echo Enigma::Desencriptar("./misArchivos/enigma.txt");
?>